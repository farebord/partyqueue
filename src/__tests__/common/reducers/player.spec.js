...
import { REQUEST_CURRENT_PLAYBACK, RECEIVED_CURRENT_PLAYBACK, ERROR_FETCHING_CURRENT_PLAYBACK, SWITCH_PLAYING } from 'common/actions/player'
...
describe('player reducer should', () => {
    ...
    it('handle RECEIVED_CURRENT_PLAYBACK', () => {
        ...
        expect(reducer({}, action)).toEqual({loading: false, fetched: true, playbackSwitching: false, test: "test"})
    })
    ...
    it('handle ERROR_FETCHING_CURRENT_PLAYBACK', () => {
        ...
        expect(reducer({}, action)).toEqual({loading: false, fetched: false, playbackSwitching: true, error: "test"})
    })
    ...
    it('handle SWITCH_PLAYING with non initial state', () => {
        ...
        expect(reducer({something: true}, action)).toEqual({playbackSwitching: true, something: true})
    })
